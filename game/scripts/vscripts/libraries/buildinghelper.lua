...
function BuildingHelper:UpgradeBuilding(building)
    ...
    local newName =  BuildingHelper.UnitKV[oldBuildingName]["Upgrade"]
    ...
    newBuilding:AddNewModifier(newBuilding, nil, "modifier_building", {duration = build_time})
...
function BuildingHelper:StartBuilding(builder)
    ...
    building:AddNewModifier(building, nil, "modifier_building", {duration = buildTime})
